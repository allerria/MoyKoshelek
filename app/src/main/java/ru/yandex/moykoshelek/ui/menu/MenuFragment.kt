...
class MenuFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        menu_statistics.setOnClickListener { router.backTo(Screens.BALANCE_SCREEN) }
        menu_settings.setOnClickListener { router.backTo(Screens.BALANCE_SCREEN) }
        menu_about.setOnClickListener { router.backTo(Screens.BALANCE_SCREEN) }
